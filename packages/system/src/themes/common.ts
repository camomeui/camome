...
export const commonTheme = {
  color: {
    ...
    neutral: {
      0: cssVar("color.gray.0"),
      1: cssVar("color.gray.1"),
      2: cssVar("color.gray.2"),
      3: cssVar("color.gray.3"),
      4: cssVar("color.gray.4"),
      5: cssVar("color.gray.5"),
      6: cssVar("color.gray.6"),
      7: cssVar("color.gray.7"),
      8: cssVar("color.gray.8"),
      9: cssVar("color.gray.9"),
    },
    info: {
      0: "#f0f9ff",
      1: "#e0f2fe",
